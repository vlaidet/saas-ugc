...
<objective>
Create well-structured documentation files in `content/docs/` for NowTS features, components, APIs, or tools. **ALWAYS use the provided script** to initialize new docs, then edit the generated file.
</objective>
...
- **API**: REST endpoints, server actions, integrations
